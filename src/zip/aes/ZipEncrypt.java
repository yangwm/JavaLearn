 ...
 * 
 * http://topic.csdn.net/u/20090114/16/a41aaa1f-b5c5-4fcd-972c-e2ce32b1535c.html
 * http://topic.csdn.net/t/20050714/13/4144100.html
 * https://truezip.dev.java.net/
 * http://www.ibm.com/developerworks/cn/java/l-security/
 * http://www.pudn.com/downloads/sourcecode/java/detail1300.html         JAVA上加密算法的实现用例
 *  
 * @author yangwm in Feb 11, 2009 11:45:15 PM
 */
public class ZipEncrypt {
    ...
    private void encrypt(String srcFile, String destFile, Key privateKey)
        ...
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");  // ?? Cipher c = Cipher.getInstance("DES/CBC/PKCS5Padding");
    ...
    public static void main(String args[]) throws Exception {
        new ZipEncrypt().encryptZip("d:/working/amslogs/ams.log_2009-01-14.log", "d:/working/amslogs2/page.zip","d:/working/public.key");

        new ZipEncrypt().decryptUnzip("d:/working/amslogs2/page.zip", "d:/working/amslogs3/","d:/working/public.key");
    }
}
