...
public class MultiServer {
    ...
    public static void main(String[] args) throws IOException {
        int port = 9527;
        System.out.println("MultiServer listen on port: " + port);
        new Thread(new MultiReactor(port)).start();
    }

}

class MultiReactor implements Runnable {
    final int selectorSize = 4;
    final Selector[] selectors = new Selector[selectorSize]; // also create threads
    int next = 0;
        ...
        public synchronized void run() {
            try {
                ...
                if (c != null) {
                    ...
                    new StatePoolHandler(selectors[next], c);
                }
