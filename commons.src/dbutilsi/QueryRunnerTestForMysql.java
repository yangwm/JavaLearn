 ...
 */
public class QueryRunnerTestForMysql {
    /**
     * Logger for this class
     */
    private static final Log logger = LogFactory.getLog(QueryRunnerTestForMysql.class);
        
    public static class DriverTester {
        public static void main(String[] args) {
            Connection conn = null;
            try {
                conn = ConnectionUtil.getConnectionForMysql();
...
>>>generateCountSql sql=select id, title, authors from book order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver
<<<generateCountSql result.toString()=select count(*) from book order by id
>>>generatePageSql sql=select id, title, authors from book order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=28, totalPage=6}
<<<generatePageSql pageSql=select id, title, authors from book order by id limit 0, 5
id ------------- title ------------- authors 
1 ------------- C++ Primer Plus ------------- duck
2 ------------- Thinking In Java ------------- bruce eckel
3 ------------- a ------------- a of authors
...
5 ------------- c ------------- c of authors
***Using BookListHandler***PageArgument(1, 5)***no params
>>>generateCountSql sql=select id, title, authors from book where title like '%Java%' order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver
<<<generateCountSql result.toString()=select count(*) from book where title like '%Java%' order by id
>>>generatePageSql sql=select id, title, authors from book where title like '%Java%' order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=1, totalPage=1}
<<<generatePageSql pageSql=select id, title, authors from book where title like '%Java%' order by id limit 0, 5
id ------------- title ------------- authors 
2 ------------- Thinking In Java ------------- bruce eckel
***Using BookListHandler***PageArgument(1, 5)***params{5}
>>>generateCountSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=23, totalPage=5}
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 0, 5
id ------------- title ------------- authors 
6 ------------- d ------------- d of authors
7 ------------- e ------------- e of authors
8 ------------- f ------------- f of authors
...
>>>generateCountSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=0, totalPage=1}
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 0, 5
id ------------- title ------------- authors 
***Using BookListHandler***PageArgument(5, 5)***params{5}
>>>generateCountSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver, pageArg=PageArgument{curPage=5, pageSize=5, totalRow=23, totalPage=5}
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 20, 5
id ------------- title ------------- authors 
26 ------------- x ------------- x of authors
27 ------------- y ------------- y of authors
28 ------------- z ------------- z of authors
...
>>>generateCountSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=5, totalPage=1}
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 0, 5
id ------------- title ------------- authors 
24 ------------- v ------------- v of authors
25 ------------- w ------------- w of authors
...
>>>generateCountSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, conn.getMetaData().getDriverName()=MySQL-AB JDBC Driver, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=1, totalPage=1}
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 0, 5
id ------------- title ------------- authors 
28 ------------- z ------------- z of authors
