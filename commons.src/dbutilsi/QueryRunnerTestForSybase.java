 ...
 */
public class QueryRunnerTestForSybase {
    /**
     * Logger for this class
     */
    private static final Log logger = LogFactory.getLog(QueryRunnerTestForSybase.class);
    
    public static class DriverTester {
        public static void main(String[] args) {
            Connection conn = null;
            try {
                conn = ConnectionUtil.getConnectionForSybase();
...
>>>generateCountSql sql=select id, title, authors from book order by id
<<<generateCountSql result.toString()=select count(*) from book order by id
<<<pageArg=PageArgument{curPage=1, pageSize=5, totalRow=28, totalPage=6}
>>>generatePageSql sql=select id, title, authors from book order by id, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=28, totalPage=6}, driverName=MySQL-AB JDBC Driver
...
>>>generateCountSql sql=select id, title, authors from book where id>? order by id
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
<<<pageArg=PageArgument{curPage=1, pageSize=5, totalRow=23, totalPage=5}
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=23, totalPage=5}, driverName=MySQL-AB JDBC Driver
...
>>>generateCountSql sql=select id, title, authors from book where id>? order by id
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
<<<pageArg=PageArgument{curPage=1, pageSize=5, totalRow=0, totalPage=1}
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=0, totalPage=1}, driverName=MySQL-AB JDBC Driver
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 0, 5
id ------------- title ------------- authors 
***Using BookListHandler***PageArgument(5, 5)***params{5}
>>>generateCountSql sql=select id, title, authors from book where id>? order by id
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
<<<pageArg=PageArgument{curPage=5, pageSize=5, totalRow=23, totalPage=5}
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, pageArg=PageArgument{curPage=5, pageSize=5, totalRow=23, totalPage=5}, driverName=MySQL-AB JDBC Driver
...
>>>generateCountSql sql=select id, title, authors from book where id>? order by id
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
<<<pageArg=PageArgument{curPage=1, pageSize=5, totalRow=5, totalPage=1}
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=5, totalPage=1}, driverName=MySQL-AB JDBC Driver
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 0, 5
id ------------- title ------------- authors 
24 ------------- v ------------- v of authors
25 ------------- w ------------- w of authors
...
>>>generateCountSql sql=select id, title, authors from book where id>? order by id
<<<generateCountSql result.toString()=select count(*) from book where id>? order by id
<<<pageArg=PageArgument{curPage=1, pageSize=5, totalRow=1, totalPage=1}
>>>generatePageSql sql=select id, title, authors from book where id>? order by id, pageArg=PageArgument{curPage=1, pageSize=5, totalRow=1, totalPage=1}, driverName=MySQL-AB JDBC Driver
<<<generatePageSql pageSql=select id, title, authors from book where id>? order by id limit 0, 5
id ------------- title ------------- authors 
28 ------------- z ------------- z of authors
